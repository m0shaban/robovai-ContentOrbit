...
class AppConfig(BaseModel):
    ...
    google_sheet_name: str = Field(
        default="ContentOrbit Control Room",
        description="Name of the Google Sheet for remote control",
    )
    google_sheet_id: Optional[str] = Field(
        default=None, description="ID of the Google Sheet (preferred over name)"
    )
